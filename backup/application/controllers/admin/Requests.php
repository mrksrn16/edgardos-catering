...
class Requests extends Admin_Controller
{
	...
	public function index() {
		...
		$this->data['schedules'] = $this->M_Schedules->get_pending_rejected();
		$this->data['subview'] = 'admin/requests/index';
	...
	public function view($id) {
		...
		$this->data['subview'] = 'admin/requests/view';
		$this->load->view('admin/main_layout', $this->data);
	}
	...
	public function edit($id) {
		...
		$this->data['packages'] = $this->M_Packages->get_all();
		$this->data['schedule'] = $this->M_Schedules->get_by_id($id);
		$this->data['subview'] = 'admin/requests/edit';
		$this->load->view('admin/main_layout', $this->data);
	}
	...
	public function accept($id) {
		...
		//Email content
		$htmlContent = "<p>Good day,</p><p>Your reservation has been approved.</p><p></p>";		
		$htmlContent .= "
			<table>
			<tr>
