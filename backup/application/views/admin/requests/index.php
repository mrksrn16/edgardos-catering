<div class="container">
  ...
  <div class="input-group pull-right col-xs-12" style="margin-bottom: 10px;">
    <?php echo form_open('admin/requests/filter_events');?>
  ...
  <table class="table table-striped" style="margin-top: 10px;">
    ...
    <tr style="background: <?php if($now >= $plus3days){ echo 'rgba(255, 0, 0, .4)';  }?>">
      ...
      <td>
        <a href="<?php echo base_url();?>admin/requests/view/<?php echo $schedule->id;?>"><button class="btn btn-info btn-xs">View</button></a>
