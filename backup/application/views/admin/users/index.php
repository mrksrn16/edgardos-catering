<div class="container">
  ...
  <table class="table table-striped" style="margin-top: 10px;">
    ...
    <tr style="display: <?php if($user->id == $this->session->userdata('id')){ echo 'none'; }?>">
      ...
      <td>
        ...
        <a href="<?php echo base_url();?>admin/users/<?php if($user->status == 1) { echo 'deactivate'; } else { echo 'activate'; }  ?>/<?php echo $user->id;?>"><?php if($user->status == 1) { echo 'Deactivate'; } else { echo 'Activate'; }  ?></a>
      </td>
    </tr>
    <?php endforeach;?>
    <?php else:?>
