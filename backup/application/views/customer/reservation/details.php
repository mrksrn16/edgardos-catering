<section class="reservation">
      ...
      <h3 class="custom-heading"><span>Reservation Details</span></h3>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="number" class="form-control" placeholder="No. of Guest" name="no_guests" required="" min="100">
            </div>
          </div>
        ...
        <div class="col-xs-12 reservation-form" style="margin-top: 20px;">
          ...
          <div class="form-group flex align-center col-xs-12">
            ...
            <div class="col-sm-10">
              <input type="checkbox" name="additionals[]" class="additionals_checkbox" value="Sounds and light with projector">Sounds and light with projector
              <input type="checkbox" name="additionals[]" class="additionals_checkbox" value="Photoboth for 2 hRs">Photoboth for 2 hRs
              <input type="checkbox" name="additionals[]" class="additionals_checkbox" value="Photo and video">Photo and video
              <input type="checkbox" name="additionals[]" class="additionals_checkbox" value="Emcee">Emcee
              <!-- <input type="checkbox" name="additionals[]" class="additionals_checkbox" value="Tiffany chair">Tiffany chair -->
              <input type="checkbox" name="additionals[]" class="additionals_checkbox" value="Motif">Motif
            </div>
          </div>
