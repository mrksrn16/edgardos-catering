<div class="container">
	<a href="<?php echo base_url();?>admin/schedules"><button class="btn btn-default"  style="margin-top: 20px;">Back</button></a>
	<h3>Schedule ID - <b><?php echo str_pad($schedule->id, 5, "0", STR_PAD_LEFT);?></b>
		<a href="<?php echo base_url();?>admin/requests/edit/<?php echo $schedule->id;?>" class="btn btn-xs btn-primary pull-right">
			Edit
		</a>
	</h3>
	<div class="col-lg-6">
	...
	<div class="col-lg-6">
		...
		<div class="col-lg-12">
			...
			<?php if($schedule->status == 'accepted'):?><a href="<?php echo base_url();?>admin/schedules/cancelled/<?php echo $schedule->id;?>" onclick="return confirm('Cancel this schedule?')" style="padding-bottom: 20px;display: block;"><button class="btn btn-danger">Cancel</button></a><?php endif;?>
			<?php if($schedule->status == 'cancelled'):?><a href="<?php echo base_url();?>admin/requests/accept/<?php echo $schedule->id;?>" onclick="return confirm('Cancel this schedule?')" style="padding-bottom: 20px;display: block;"><button class="btn btn-primary">Accept</button></a><?php endif;?>
		</div>
	</div>
</div>