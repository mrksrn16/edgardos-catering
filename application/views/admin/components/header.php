        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
                ...
                <?php $archiveSched = $this->M_Schedules->get_archived();?>
                <?php if($archiveSched):?>
                <span class="badge" style="position: absolute; top: 10px; right: 0; background: #009688;"><?php echo count($archiveSched);?></span>
                <?php endif;?>
                </a>
                <ul class="dropdown-menu">
                  <!-- <li><a href="<?php echo base_url();?>admin/user/profile">Profile</a></li> -->
                  <li><a href="<?php echo base_url();?>admin/archived">View archived</a></li>
                </ul>
              </li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
