<div class="container">
	...
	<h3>Request ID - <b><?php echo str_pad($schedule->id, 5, "0", STR_PAD_LEFT);?></b></h3>
	...
	<div class="col-lg-6">
		...
		<div class="col-lg-12">
			...
			<a href="<?php echo base_url();?>admin/requests/accept/<?php echo $schedule->id;?>" onclick="return confirm('Accept customer reservation and send email confirmation?')"><button class="btn btn-primary">Accept</button></a>
			<a href="<?php echo base_url();?>admin/requests/reject/<?php echo $schedule->id;?>" onclick="return confirm('Reject customer reservation?')"><button class="btn btn-danger">Reject</button></a>
			<br>
			<a href="<?php echo base_url();?>admin/requests/sendmail/<?php echo $schedule->id;?>" onclick="return confirm('Send email to notify customer?')" style="margin-top: 20px;margin-bottom:50px;display:block;"><button class="btn btn-warning">Send Email/Notify Customer</button></a>
		</div>
	</div>
</div>