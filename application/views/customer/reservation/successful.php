      ...
      <h3 class="custom-heading"><span>Successful</span></h3>
       	<div class="row flex justify-center">
       		<div class="col-xs-6 reservation-form relative">
	       		...
	       		<div>
	       		<a href="<?php echo base_url();?>reservation/edit/<?php echo $schedule->id?>" class="btn btn-info">Edit</a>
	       		<a href="<?php echo base_url();?>reservation/confirm/<?php echo $schedule->id?>" class="btn btn-primary" onclick="return confirm('Confirm Reservation?')">Confirm</a>
       			<button class="btn btn-success" style="float: right;" onclick="printDiv('printableArea')">Print</button>
	       		</div>
