...
<div class="container calendar--container">
    <p>Legend</p>
    <span style="width: 20px;height: 20px;margin:0 5px;background: white;display: inline-block;border:1px solid black;">&nbsp;</span> <small><b>White</b> - Available date</small>
    ...
    <ul>
        ...
        <li>Payment is thru smart padala</li>
    </ul>
    <div id="calendar"></div>
    <hr>
</div>
